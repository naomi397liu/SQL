...
COPY public.grades (id, grade, project_title, student_github) FROM stdin;
\N	10	Markov	jhacks
\.
...
--
-- Name: grades grades_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: vagrant
--

ALTER TABLE ONLY public.grades
    ADD CONSTRAINT grades_id_fkey FOREIGN KEY (id) REFERENCES public.students(id);
